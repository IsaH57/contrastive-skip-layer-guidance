...
This script generates images for prompts where text is present 
in the image. By comparing intermediate outputs of the model to 
the final result, we extract information about which layers 
...
dataset_path = os.path.join(os.getcwd(), "prompts_text.json")
